...
<h3>SmartShop</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> © Desarrollo en equipos TSP - Politecnico Grancolombiano 2022.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">admin@tspsubgrupo4.com</a></span>
                </div>
                
            </li>

            <li class="dropdown">
                <a class="btn btn-info btn-lg dropdown-toggle" data-toggle="dropdown" href="#change-colors" aria-expanded="false">Colores</a>						
                    <ul class="dropdown-menu" role="menu">
                        <li role="presentation"><a role="menuitem" class="changecolor blue-text" tabindex="-1" href="#" title="Blue color">Azul</a></li>
                    </ul>
            </li>
            ...
            <ul class="btn btn-info">
					<li class="">
						<a href="track-orders.php" class="" ><span class="key">Seguimiento</b></a>
